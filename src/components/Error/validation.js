...
let error = {}; 
  if (!validarEmail(obj.user)) error.user = "Pease type a valid email";
  ...
  if (tiene_numeros(obj.password) === 0) error.password ="The password should contain at least one number";
  return error;
}
